...
public class UseObjectStream {
	...
	public void useObjctOutputStream() throws IOException {
	...
	public void useObjctInputStream() throws IOException, ClassNotFoundException {
		//객체를 읽기위한 스트림 열기
...
//		try {
//			uos.useObjctOutputStream();
//		} catch (IOException e) {
//			e.printStackTrace();
//		}//end catch
		System.out.println("=======================");
		try {
			uos.useObjctInputStream();
