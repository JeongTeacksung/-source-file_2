...
public class NamecardView extends JFrame{
	...
	public NamecardView() {
		...
		jlPreview=new JLabel(new ImageIcon("C:/dev/workspace/javase_prj2/src/day0111/images/no_image.png"));
		...
		jbtImg.setBounds(112, 285, 100, 25);
		jbtAdd.setBounds(112, 315, 100, 25);
